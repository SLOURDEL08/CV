  ...
  return (
    <div className="container-about">
      ...
      <div className='right-about'>
        <div className='fastmenu'><span>Accès <b>rapide</b></span><button onClick={toggleMenu}><img src='more.png' alt='navigation' /></button></div>
        ...
        <div className='containtitle-rightabout'>
          <img src='work.png' /><p className='title-exp'>Expériences</p>
        </div>
